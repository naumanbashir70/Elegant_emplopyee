...
class MyNextShiftWidget extends StatefulWidget {
  const MyNextShiftWidget({
    super.key,
  ...
  static String routeName = 'MyNextShift';
  static String routePath = '/myNextShift';
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          backgroundColor: Color(0xFF10283D),
          appBar: AppBar(
            backgroundColor: Color(0xFF606D02),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0xFF606D02), Colors.black, Colors.black],
                  stops: [0.0, 0.9, 1.0],
                              ...
                              child: Row(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      getJsonField(
                                        myNextShiftJobDetailsResponse.jsonBody,
                                        r'''$.shift_text''',
                                      ).toString(),
