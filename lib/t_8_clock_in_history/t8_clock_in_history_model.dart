...
import 'dart:ui';
import '/index.dart';
import 't8_clock_in_history_widget.dart' show T8ClockInHistoryWidget;
...
class T8ClockInHistoryModel extends FlutterFlowModel<T8ClockInHistoryWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/elegant-employee-g1luv7/tab=uiBuilder&page=T_8_ClockInHistory',
        searchReference:
            'reference=OhJUXzhfQ2xvY2tJbkhpc3RvcnlQAVoSVF84X0Nsb2NrSW5IaXN0b3J5',
        widgetClassName: 'T_8_ClockInHistory',
      );
}
