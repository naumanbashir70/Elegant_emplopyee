...
class ShiftCancelledWidget extends StatefulWidget {
  const ShiftCancelledWidget({
    super.key,
  ...
  static String routeName = 'ShiftCancelled';
  static String routePath = '/shiftCancelled';
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'This job has been cancelled\nWe apologize for any inconvenience;\nwe will keep your name in our priority\nlist for the next available job.',
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if ((_model.apiResult6st?.succeeded ??
                                          true)) {
