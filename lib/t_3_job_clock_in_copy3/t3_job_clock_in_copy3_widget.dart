...
class T3JobClockInCopy3Widget extends StatefulWidget {
  const T3JobClockInCopy3Widget({
    super.key,
  ...
  static String routeName = 'T_3_Job_ClockInCopy3';
  static String routePath = '/t3JobClockInCopy3';

  @override
  State<T3JobClockInCopy3Widget> createState() =>
      _T3JobClockInCopy3WidgetState();
}

class _T3JobClockInCopy3WidgetState extends State<T3JobClockInCopy3Widget>
    with RouteAware {
  late T3JobClockInCopy3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => T3JobClockInCopy3Model());
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      _model.debugBackendQueries[
                                              'ClientDetailByCodeCall_statusCode_DropDown_mklll1tl'] =
                                          debugSerializeParam(
                                      ...
                                      _model.debugBackendQueries[
                                              'ClientDetailByCodeCall_responseBody_DropDown_mklll1tl'] =
                                          debugSerializeParam(
                                        dropDownClientDetailByCodeResponse
                                            .bodyText,
                                        ParamType.String,
