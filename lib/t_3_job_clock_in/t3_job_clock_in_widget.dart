...
class T3JobClockInWidget extends StatefulWidget {
  const T3JobClockInWidget({
    super.key,
  ...
  static String routeName = 'T_3_Job_ClockIn';
  static String routePath = '/t3JobClockIn';
...
class _T3JobClockInWidgetState extends State<T3JobClockInWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => T3JobClockInModel());
                            ...
                            onTap: () async {
                              ...
                              if ((_model.clockInStatus?.succeeded ?? true)) {
                                if (getJsonField(
                                  ...
                                  if ((_model.clockInShift?.succeeded ??
                                      true)) {
                                    FFAppState().ClockInTime = dateTimeFormat(
