...
class MyProfileUpdateEmailWidget extends StatefulWidget {
  const MyProfileUpdateEmailWidget({
    super.key,
  ...
  static String routeName = 'MyProfileUpdateEmail';
  static String routePath = '/myProfileUpdateEmail';

  @override
  State<MyProfileUpdateEmailWidget> createState() =>
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.emailupdateTextController,
                                        ...
                                        validator: _model
                                            .emailupdateTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (dialogContext) {
                                          return Dialog(
                                            ...
                                            child: EmailConfirmPopInfoWidget(
                                              email: _model
