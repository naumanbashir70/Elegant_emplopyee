  ...
  ErrorWidget.builder = (FlutterErrorDetails details) {
    try {
      ...
      for (final line in stackTrace.split('\n')) {
        if (line.startsWith('packages/elegant_employee/')) {
...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<ElegantEmployeeAuthUser> userStream;
  ...
  void initState() {
    ...
    userStream = elegantEmployeeAuthUserStream()
      ..listen((user) {
