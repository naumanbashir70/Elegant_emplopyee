...
class T2ClockInCopyModel extends FlutterFlowModel<T2ClockInCopyWidget> {
  ...
  ApiCallResponse? _clockIn;
  set clockIn(ApiCallResponse? value) {
    _clockIn = value;
    debugLogWidgetClass(this);
  }

  ApiCallResponse? get clockIn => _clockIn;
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/elegant-employee-g1luv7/tab=uiBuilder&page=T_2_ClockInCopy',
        searchReference:
            'reference=Og9UXzJfQ2xvY2tJbkNvcHlQAVoPVF8yX0Nsb2NrSW5Db3B5',
        widgetClassName: 'T_2_ClockInCopy',
      );
}
