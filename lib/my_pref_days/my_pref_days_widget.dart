...
class MyPrefDaysWidget extends StatefulWidget {
  const MyPrefDaysWidget({
    super.key,
  ...
  static String routeName = 'MyPrefDays';
  static String routePath = '/myPrefDays';
...
class _MyPrefDaysWidgetState extends State<MyPrefDaysWidget> with RouteAware {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyPrefDaysModel());
  }
                    ...
                    return Builder(
                      builder: (context) {
                        ...
                        return ListView.separated(
                          ...
                          itemCount: varDays.length,
                          separatorBuilder: (_, __) => SizedBox(height: 15.0),
                          itemBuilder: (context, varDaysIndex) {
                            final varDaysItem = varDays[varDaysIndex];
                            return Material(
