...
class FullTimeJobWidget extends StatefulWidget {
  const FullTimeJobWidget({
    super.key,
  ...
  static String routeName = 'FullTimeJob';
  static String routePath = '/fullTimeJob';
