...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    elegantEmployeeAuthUserSubject.add(
      ElegantEmployeeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ElegantEmployeeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ElegantEmployeeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ElegantEmployeeAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    elegantEmployeeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ElegantEmployeeAuthUser? currentUser;
