...
class MyProfilePicCurrentWidget extends StatefulWidget {
  const MyProfilePicCurrentWidget({
    super.key,
  ...
  static String routeName = 'MyProfilePicCurrent';
  static String routePath = '/myProfilePicCurrent';

  @override
  State<MyProfilePicCurrentWidget> createState() =>
...
class _MyProfilePicCurrentWidgetState extends State<MyProfilePicCurrentWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyProfilePicCurrentModel());
  }
                                    ...
                                    Container(
                                      ...
                                      child: Image.network(
                                        DashboardDataCall.image(
                                          myProfilePicCurrentDashboardDataResponse
                                              .jsonBody,
                                        )!,
                                        fit: BoxFit.cover,
                                      ),
