...
class ShiftDetailsbackupMay25Widget extends StatefulWidget {
  const ShiftDetailsbackupMay25Widget({
    super.key,
  ...
  static String routeName = 'ShiftDetailsbackupMay25';
  static String routePath = '/shiftDetailsbackupMay25';

  @override
  State<ShiftDetailsbackupMay25Widget> createState() =>
      _ShiftDetailsbackupMay25WidgetState();
}
