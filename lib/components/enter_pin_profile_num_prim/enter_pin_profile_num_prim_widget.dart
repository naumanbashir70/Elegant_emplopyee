...
class EnterPinProfileNumPrimWidget extends StatefulWidget {
  const EnterPinProfileNumPrimWidget({
    super.key,
  ...
  @override
  State<EnterPinProfileNumPrimWidget> createState() =>
      _EnterPinProfileNumPrimWidgetState();
}
