...
class TPClockOutSuccessWidget extends StatefulWidget {
  const TPClockOutSuccessWidget({
    super.key,
  ...
  @override
  State<TPClockOutSuccessWidget> createState() =>
...
class _TPClockOutSuccessWidgetState extends State<TPClockOutSuccessWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TPClockOutSuccessModel());
