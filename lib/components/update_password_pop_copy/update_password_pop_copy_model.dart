  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          'apitoken': debugSerializeParam(
            ...
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/elegant-employee-g1luv7?tab=uiBuilder&page=UpdatePasswordPopCopy',
            searchReference:
        ...
        link:
            'https://app.flutterflow.io/project/elegant-employee-g1luv7/tab=uiBuilder&page=UpdatePasswordPopCopy',
        searchReference:
            'reference=OhVVcGRhdGVQYXNzd29yZFBvcENvcHlQAFoVVXBkYXRlUGFzc3dvcmRQb3BDb3B5',
        widgetClassName: 'UpdatePasswordPopCopy',
      );
}
