  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetStates: {
          'textFieldText': debugSerializeParam(
            ...
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/elegant-employee-g1luv7?tab=uiBuilder&page=T_1_NoClockOutTimeCopy',
            name: 'String',
            nullable: true,
          ),
        ...
        link:
            'https://app.flutterflow.io/project/elegant-employee-g1luv7/tab=uiBuilder&page=T_1_NoClockOutTimeCopy',
        searchReference:
            'reference=OhZUXzFfTm9DbG9ja091dFRpbWVDb3B5UABaFlRfMV9Ob0Nsb2NrT3V0VGltZUNvcHk=',
        widgetClassName: 'T_1_NoClockOutTimeCopy',
      );
}
