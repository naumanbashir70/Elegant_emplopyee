...
class T1NoClockOutTimeCopyWidget extends StatefulWidget {
  const T1NoClockOutTimeCopyWidget({super.key});

  @override
  State<T1NoClockOutTimeCopyWidget> createState() =>
      _T1NoClockOutTimeCopyWidgetState();
}

class _T1NoClockOutTimeCopyWidgetState extends State<T1NoClockOutTimeCopyWidget>
    with RouteAware {
  late T1NoClockOutTimeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => T1NoClockOutTimeCopyModel());
