...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/SwiftyGif/SwiftyGif.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/file_picker/file_picker_ios_privacy.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/flutter_secure_storage/flutter_secure_storage.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/image_picker_ios/image_picker_ios_privacy.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/map_launcher/map_launcher_privacy.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/sqflite/sqflite_darwin_privacy.bundle"
